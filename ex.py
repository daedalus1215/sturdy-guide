...
ch8_string = pd.Series(["one string", "two string", "red string", "blue string","one string", "two string", "red string", "blue string","one string", "two string", "red string", "blue string"])
